...
const PALETTE: Record<string, string> = {
  ...
  q: '#7ed6df', // aqua
  Q: '#22a6b3', // dark aqua
  v: '#3b5bd9', // penguin royal blue
  V: '#2a41a8', // penguin blue shade
};

type Grid = string[];

// ---- Penguin player (18x20), 2 walk frames per facing ----
// Original art inspired by the classic Club Penguin look: round royal-blue
// body, white belly, high-set eyes, small orange beak, orange feet.
