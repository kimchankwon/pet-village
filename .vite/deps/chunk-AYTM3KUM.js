...
var AuthenticationManager = class {
  constructor(syncState, callbacks, config) {
    ...
    __publicField8(this, "initialAuthTokenReuse");
    __publicField8(this, "lastRefreshChange");
  ...
  onTransition(serverMessage) {
    ...
    if (this.authState.state === "waitingForServerConfirmationOfCachedToken") {
      ...
      const cachedToken = (_a = this.syncState.getAuth()) == null ? void 0 : _a.value;
...
//# sourceMappingURL=chunk-AYTM3KUM.js.map
