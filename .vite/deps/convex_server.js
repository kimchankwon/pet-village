...
async function getTransactionMetrics() {
  ...
  try {
    ...
    if ((_a = e.message) == null ? void 0 : _a.includes("Unknown async operation")) {
      throw new Error(
...
async function getRequestMetadata() {
  const { ip, userAgent, requestId, scheduledFunctionId } = await performAsyncSyscall("1.0/getRequestMetadata", {});
